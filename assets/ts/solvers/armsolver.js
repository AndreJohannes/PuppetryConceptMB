...
(function (Solver) {
    var Arm = (function (_super) {
        ...
        Arm.prototype.reimposeConstraints = function (state) {
            ...
            var r = Math.sqrt(Math.pow((x2 - x3), 2) + Math.pow((y2 - y3), 2) + Math.pow((z2 - z3), 2));
            var delta_r = rNominal - r;
        ...
        Arm.prototype.evaluate = function (state) {
            ...
            var v13 = -2 * Math.pow((x2dot - x3dot), 2) - 2 * (x2 - x3) * (-fx - k * x2dot + k * x3dot) - 2 * Math.pow((y2dot - y3dot), 2) - 2 * (y2 - y3) * (-fy + g - k * y2dot + k * y3dot) - 2 * Math.pow((z2dot - z3dot), 2) - 2 * (z2 - z3) * (-fz - k * z2dot + k * z3dot);
